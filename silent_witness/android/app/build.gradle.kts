...
// Optional release signing. Drop a `android/key.properties` file next to this
// module with storeFile / storePassword / keyAlias / keyPassword to sign real
// releases; without it the release build falls back to the debug key so that
// `flutter build apk --release` works out of the box.
