...
- **سياق ثابت لكل مجموعة** (المشروع، الهدف، القيود) يعرفه كل الوكلاء والقاضي في كل رد.
- **بحث في كل المحادثات** من الشاشة الرئيسية، وتثبيت المحادثات المهمة.
- **تصدير المحادثة كتقرير HTML** أنيق قابل للطباعة، مع ملخص القرارات.
- **سجل القرارات**: كل أحكام القاضي في مكان واحد (تبويب "القرارات" في الملفات).
- **مشاركة واستيراد الوكلاء** كملف JSON (وكيل واحد أو فريق كامل) لتبادلها مع الأصدقاء.
- **مكالمة صوتية 📞** مع الفريق: تتكلم بالميكروفون، وكل وكيل يردّ بصوته الخاص (نبرة وسرعة مختلفة) بأسلوب حديث طبيعي، جملةً جملة أثناء الكتابة، والميكروفون يفتح تلقائياً بعد كل رد. وقراءة الردود صوتياً في الدردشة العادية (اختياري).
- **تسجيل دخول بجوجل** في الوضع المستضاف، وتنبيه بوجود تحديث للنسخ المثبّتة يدوياً.
