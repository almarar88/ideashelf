...
export function presetAgents(lang: Lang): Agent[] {
  return RAW.map((r) => {
    ...
    return {
      ...
      webSearch: true, maxSearches: 5, creativity: 55, humor: 60, model: "default", active: true,
      createdAt: Date.now(),
      ...r.extra,
    };
  });
...
export const SESSION_EXAMPLES: Record<Lang, string[]> = {
  ar: [
    ...
    "أبا أطلق تطبيقي في الإمارات ولا السعودية أول؟ الميزانية 50 ألف دولار",
